...
namespace mysql {
    ...
    public:
        ...
        const data_type* get_columns() const 
        {
            return &_data;
        }
    ...
    protected:
          int update_row(CRow& row, const uint8_t** pdata, size_t* len, uint64_t ncolumns,CMemBlock *usedcolumns_bitmap, CMemBlock *nullfileds_bitmap);
